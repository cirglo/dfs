...
//go:generate protoc --go_out=. --go-grpc_out=. auth.proto
...
//go:generate mockery --name=ConnectionFactory --with-expecter --dir=./ --output=../mocks --outpkg=mocks
//go:generate mockery --name=AuthClient --with-expecter --dir=./ --output=../mocks --outpkg=mocks
...
//go:generate mockery --name=AuthServer --with-expecter --dir=./ --output=../mocks --outpkg=mocks
